...
<head>
    ...
    <title>Nice Admin Lite - Free Bootstrap 4 Admin Template</title>
    <!-- Custom CSS -->
...
<!-- ============================================================== -->
    <div id="main-wrapper">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item pr-3">
                                    <a href="https://wrappixel.com/templates/niceadmin-lite/" class="btn btn-custom btn-outline-info btn-lg" target="_blank">Free Download</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="container">
                    <div class="row justify-content-md-center pt-5">
                        <div class="col-md-9 text-center">
                            <h2 class="text-dark">Create Stunning User Inteface for your <span class="font-bold">Applications</span> & <span class="font-bold">Products</span> with <span class="border-bottom border-dark"> Nice Admin</span></h2>
                        </div>
                    </div>
                    <div class="row py-5">
                        <!-- ============================================================== -->
                        ...
                        <div class="col-md-6">
                            <div class="card pro-demo p-2 ml-1">
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <h2 class="text-info font-medium">Pro Version</h2>
                                        <h4 class="text-dark">$29 Only</h4>
                                    </div>
                                    <div class="live-box text-center mt-4">
                                        <img class="img-fluid" src="../assets/images/pro-demo.jpg" alt="Pro version">
                                        <div class="overlay">
                                    ...
                                    <div class="row text-dark mt-5">
                                        <div class="col-md-6">
                                            <ul class="list-unstyled listing">
                                                ...
                                                <li><i class="mdi mdi-disk text-info"></i>Right-to-Left(RTL) Verion</li>
                                                ...
                                                <li><i class="mdi mdi-disk text-info"></i>Bootstrap 4 Version</li>
                                                <li><i class="mdi mdi-disk text-info"></i>Fully Responsive Pages</li>
                                            </ul>
                                        </div>
                                        <div class="col-md-6">
                                            <ul class="list-unstyled listing">
                                                <li><i class="mdi mdi-disk text-info"></i>10+ Unique Demos</li>
                                                <li><i class="mdi mdi-disk text-info"></i>6+ Ready to Use App</li>
                                    ...
                                    <div class="text-center mt-4 mb-3">
                                        <a href="https://wrappixel.com/templates/niceadmin/" class="btn btn-custom btn-info btn-lg" target="_blank">Buy Pro Version</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- ============================================================== -->
        <footer class="text-center p-4"> All Rights Reserved by Nice admin. Designed and Developed by <a href="https://wrappixel.com">WrapPixel</a>.</footer>
    </div>
</body>
<!-- ============================================================== -->
<!-- All Jquery -->
